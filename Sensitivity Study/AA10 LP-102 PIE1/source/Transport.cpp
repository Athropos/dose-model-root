...
and require an half life and a function (optional) at the declaration. Default: t1/2 = 1e9 and constant release from t=0s to t= 1400000s; 
...
Transport::Transport(Source S0, double time_step = 100, double final_time = 1500000):pTime_step(time_step),
...
//############################# TRANSPORT #####################################
    ...
    for (int step=0; step<steps_number+1; step++){
        ...
        S(0) = src.ConstEval(step*time_step)*time_step;
